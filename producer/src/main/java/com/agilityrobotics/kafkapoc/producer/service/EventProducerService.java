...
public class EventProducerService {
  ...
  public void emitCloudEvent(final Facility facility, final Message message) {
    this.cloudEventKafkaTemplate.sendEvent("kafka-poc-producer", this.topic, facility, message);
  }
